...
func (s *ListingStore) CreateListing(ctx context.Context, l model.ServiceProviderListing) (string, error) {
	row := s.db.QueryRowContext(ctx, `
		...
		l.CondominiumID, l.CategoryID, l.Name, l.Phone, l.PhoneDigits, sharedstore.NullString(l.Notes),
		sharedstore.NullString(l.RecommendedByUnitID), l.RecommendedByUnitCode, l.SubmittedBy)
	var id string
...
func (s *ListingStore) UpdateListing(ctx context.Context, l model.ServiceProviderListing) error {
	res, err := s.db.ExecContext(ctx, `
		...
		l.CategoryID, l.Name, l.Phone, l.PhoneDigits, sharedstore.NullString(l.Notes), l.ID, l.CondominiumID)
	if err != nil {
...
func (s *ListingStore) GetListingByID(ctx context.Context, id string) (model.ServiceProviderListing, error) {
	...
	if errors.Is(err, sql.ErrNoRows) {
		return model.ServiceProviderListing{}, sharedstore.ErrNotFound
	}
	if err != nil {
